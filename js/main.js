(function(){
	...
	function generateData(data, tabletop) {
	 ...
	 function genTop(){
	 	var code = "<div class = 'notable_embed_key'><textarea readonly><script id = 'notable-app-source-box' src='"+srclink+"' sheetid='"+public_spreadsheet_url+"'></script></textarea></div>"
	  	return code;
	  }
